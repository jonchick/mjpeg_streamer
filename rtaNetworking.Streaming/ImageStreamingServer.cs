        ...
        private void ClientThread(object client)
        {
            ...
            try
            {
                using (MjpegWriter wr = new MjpegWriter(new NetworkStream(socket, true)))
                {
                    ...
                    foreach (var imgStream in Screen.Streams(ImagesSource))
                    {
                        if (this.Interval > 0)
        ...
        public static IEnumerable<Image> Snapshots(int width,int height,bool showCursor)
        {
            ...
            */
            ...
            while (true)
            {
                ...
                */
                System.Net.WebRequest request = System.Net.WebRequest.Create( "http://vps.yolahome.ru/webcam" );
                System.Net.WebResponse response = request.GetResponse();
                System.IO.Stream responseStream = response.GetResponseStream();
                bitmap2 = new Bitmap( responseStream );

                yield return bitmap2;
